...
const envVariable = require("./envSetup");

envVariable.config();

const sendEmail = (ticketId, useremail, userName, ticketTitle)=>{
  const messageURL = `http://localhost:3400/user/view/ticket/${ticketId}`;

  const transporter = nodemailer.createTransport({
    host: process.env.MAILHOST, //Email created by Emmanuel
  ...
  const options = {
    ...
    subject: `You have received a new Message`, // Subject line
...
<![endif]-->
  ...
  <tbody>
    <tr>
      <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
        <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="100" alt="" data-proportionally-constrained="true" data-responsive="false" src="https://capacitybay.org/wp-content/uploads/2018/12/CapacityBay-Logo1.png" >
      </td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Hello, ${userName}!&nbsp;</span></div><div></div></div></td>
    </tr>
  </tbody>
</table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
  <tbody>
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">You have recived a message from our team</span><span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"> in regards to ticket, with the Ticket Title: <b>${ticketTitle}</b></span><span style="font-size: 18px">.</span></div>
          ...
          <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
            <tbody>
              ...
              <td align="center" bgcolor="#ffbe00" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                <a href="${messageURL}" style="background-color:#2a9852; border:1px solid #2a9852; border-color:#2a9852; border-radius:0px; border-width:1px; color:#fff; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">View Message</a>
              </td>
              </tr>
            </tbody>
          </table>
  ...
  <tbody>
    <tr>
      <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="6E6E6E">
                                          ...
                                          <div class="Unsubscribe--addressLine"><p class="Unsubscribe--senderName" style="font-size:12px; line-height:20px;">CapacityBay</p><p style="font-size:12px; line-height:20px;"><span class="Unsubscribe--senderAddress">9701 Apollo Drive suite 301 Largo MD 20774</span>, <span class="Unsubscribe--senderCity">info@capacitybay.org</span>, <span class="Unsubscribe--senderState"></span> <span class="Unsubscribe--senderZip">(301) 304-1BAY</span></p></div>
  ...
  transporter.sendMail(options, (err, respos)=>{
    if(err){
